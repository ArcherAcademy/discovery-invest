        ...
        <div className="flex-1 min-w-0 w-full space-y-4">
          ...
          {video.content_type !== 'pdf' && !completed && videosLeft > 0 && (
            ...
            >
              ...
              <p className="text-sm" style={{ color: 'rgba(13,15,20,0.7)' }}>
                ...
                {' '}tot je bonus en de vermogens call vrijspeelt
              </p>
            </div>
          )}
          ...
          {video.content_type !== 'pdf' && completed && (
            ...
            >
              ...
              <p className="text-sm font-medium" style={{ color: '#0d0f14' }}>
                {isLastCoreVideo
                  ? 'Alle 6 kernvideo\'s bekeken. Je bonus en de vermogens call zijn vrijgespeeld!'
          ...
          <div className="flex items-center justify-between gap-4 pb-6">
            ...
            {(() => {
              ...
              // zodat het afrondscherm en de vrijgespeelde vermogens call zichtbaar blijven.
              if (isLastCoreVideo) {
                if (!completed) {
                  return (
                    <div
              ...
              if (!nextVideo) {
                ...
                // stuur terug naar /traject waar de vermogens call staat.
                if (coreCompleted >= 6) {
                  return (
                    <Link
                      href="/traject"
