          ...
          <div className="rounded-2xl border overflow-hidden"
            ...
            <div className="px-5 pt-5 pb-4 border-b" style={{ borderColor: '#f0f3fb' }}>
              ...
              <p className="text-xs" style={{ color: 'rgba(13,15,20,0.45)' }}>
                Kijk alle 6 kernvideo&apos;s en speel je bonus + persoonlijk oriëntatiegesprek vrij
              </p>
            </div>
                ...
                <div className="flex-1">
                  ...
                  >
                    ...
                    <div className="flex items-center gap-2 mb-3">
                      ...
                      <span className="text-xs font-semibold" style={{ color: allCoreCompleted ? '#0d0f14' : 'rgba(13,15,20,0.3)' }}>Oriëntatiegesprek</span>
                    </div>
